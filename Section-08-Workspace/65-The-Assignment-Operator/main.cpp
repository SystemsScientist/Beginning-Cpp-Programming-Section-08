 ...
 *                  + second, assignment occurs when a new value is assigned to a variable
 *          - print variables to test and see how the values change through the program
 */
...
int main(void) {
    ...
    // variables below are initialized
    int num1 {10};
    int num2 {20};
